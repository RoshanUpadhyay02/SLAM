...
class BuildEnvironment(object):
    ...
    def __init__(self, robot=Mouse, dimensions=(1200, 600), filename= r"/home/roshanupahdyay/Documents/ExtraS/Clubs/Optizen/SLAM/Code/With static image/floorplan.png"):
